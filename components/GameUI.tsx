...
const GameUI = ({
  ...
  }, [isWalletConnected, walletId, fullAddress, handleWalletConnect, joinGame, rollDice, buyAntidote]);
  ...
  return (
    <>
      ...
      >
        <img src="/assets/Play.svg" alt="How to Play" className="how-to-play-icon" />
        <span
          style={{
            color: '#006400',
      ...
      {!walletId && !isWalletConnected ? (
        <WalletConnect
          onConnect={handleWalletConnect || (() => Promise.resolve())}
        />
      ) : walletId ? (
        <p
          className="neon-text"
      ...
      >
        ...
        >
          <img src="/assets/redfrog.svg" alt="Join Game" style={{ width: '150px', height: '150px' }} />
          <div
            className="tooltip"
            style={{
              visibility: 'visible',
      ...
      >
        <button
          ...
          onClick={() => {
            console.log('Buy antidote button clicked', {
              isWalletConnected,
              loading,
              isActive: playerInfo.isActive,
              buyAntidote: !!buyAntidote
            });
            if (buyAntidote) {
              buyAntidote();
            } else {
              console.error('buyAntidote function is undefined');
            }
          }}
        ...
        >
          <img src="/assets/antidot.png" alt="Buy Antidote" style={{ width: '100%', height: '100%' }} />
        </button>
        <div
          className="tooltip"
          style={{
